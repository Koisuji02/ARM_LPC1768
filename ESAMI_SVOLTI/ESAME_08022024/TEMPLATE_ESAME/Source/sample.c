...
int main (void) {
  ...
  BUTTON_init();												/* BUTTON Initialization              */
	...
	init_timer(0,0,0,3,0x3D090); // 0.01s (centesimi di secondo)
	
	init_timer(1,0,0,3,0x2DC6C0); // 0.12s (alternanza)
	
	init_timer(2,0,0,3,0x7735940); // 5s
	
	init_timer(3,0,0,3,0x8F0D180); // 6s
