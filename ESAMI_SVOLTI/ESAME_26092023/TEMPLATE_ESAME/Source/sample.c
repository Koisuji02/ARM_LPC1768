...
int main (void) {
  ...
  BUTTON_init();												/* BUTTON Initialization              */
	...
	init_timer(0,0,0,3,0x7270E0*0.1); // SRI = 011 = 3(si interrupt); 0.3s = 300ms
	
	init_timer(1,0,0,3,0xBEBC20*0.1); // 0.5s
	
	//init_timer(2,0,0,3,0x2FAF080); // 0.5Hz = 2s
	
	init_timer(3,0,0,3,0xEE6B280*0.1); // 10s -> SRI = 011 = 3 (si interrupt)
