...
int main (void) {
  ...
  BUTTON_init();												/* BUTTON Initialization              */
	...
	init_timer(0,0,0,3,0x5F5E10); // 0.25s (lampeggio a pressione)
	
	init_timer(1,0,0,3,0x5F5E10); // 0.25s (lampeggio di 1 e 2)
	
	init_timer(2,0,0,3,0x2FAF08); // 0.125s -> 3s = 3*8 = 24 (counter)
	
	//init_timer(3,0,0,3,0x2FAF08); // 0.125s
