...
int main (void) {
  ...
  BUTTON_init();												/* BUTTON Initialization              */
	...
	init_timer(0,0,0,3,0x3D090/scaler); // 0.01s
	
	init_timer(1,0,0,3,0x2DC6C0/scaler); // 120ms = 0.12s
	
	init_timer(2,0,0,3,0x7735940/scaler); // 5s
	enable_timer(2);							// per copiare var in vet
	
	init_timer(3,0,0,3,0x8F0D180/scaler); // 6s
