...
stat_satisfaction				PROC
								...
								MOV r12, sp
								PUSH {r4-r8, r10-r11, lr}  		; Salva i registri utilizzati
								LDR r4, [r12] ; r4 = indirizzo di PN, dove dovrò fare la store
								ADD r12, r12, #4		; prossimo elemento di stack
								LDR r9, [r12]			; r9 = indirizzo di PI, dove farò la store
								MOV r5, #0		; r5 = totale clienti
								MOV r6, #0		; r6 = PS
								MOV r7, #0		; r7 = PN
								MOV r8, #0		; r8 = PI
								MOV r10, #100
								...
								STRB r7, [r4]
								STRB r8, [r9]
end_satisfaction				MOV r0, r5		; torno totale
								POP{r4-r8, r10-r11, pc}
								ENDP
									
								; VANNO AGGIUNTI SORTING CRESCENTE E DECRESCENTE (es. BUBBLESORT) [da capire come fare prototipo anche C]
