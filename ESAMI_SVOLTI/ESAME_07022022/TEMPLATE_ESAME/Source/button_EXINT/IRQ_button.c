...
{
	enable_RIT();									// passo gestione del button EINT0 nel RIT
...
{
	enable_RIT();									// passo la gestione del button EINT1 nel RIT
...
{
	enable_RIT();									// passo gestione del button EINT2 nel RIT
