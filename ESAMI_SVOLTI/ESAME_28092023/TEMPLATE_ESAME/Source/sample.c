...
int main (void) {
  ...
  BUTTON_init();												/* BUTTON Initialization              */
	...
	init_timer(0,0,0,3,0xBAEB90); // 490ms = 0.49s (lampeggio)
	
	init_timer(1,0,0,3,0x2FAF080); // 2s elimina lampeggio e riabilita KEY1
	
	init_timer(2,0,0,2,0x997B61C0); // 1.43 min = 103s; SRI = 010 = 2 (no interrupt)
	
	init_timer(3,0,0,3,0xFE502A); // 1.5Hz = 0.66667s
	
	svuotaVet(vet, N); // inizialmente vuoto
