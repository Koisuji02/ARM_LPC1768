...
int value_tmp = 0; // TIM2->TC
uint8_t val; // 8 bit da prendere da TC se accettabili
unsigned char risultato = 0;
int counterNonAccettabili = 0;
...
int main (void) {
  ...
  BUTTON_init();												/* BUTTON Initialization              */
	...
	init_timer(0,0,0,3,0xBAEB90); // TIMER0 -> lampeggia i timer (0.49s)
	
	init_timer(1,0,0,3,0x2FAF080); // TIMER1 -> spegne timer0 (2s)
	
	init_timer(2,0,0,3,0x997B61C0); // TIMER2 -> genera numeri; 1m 43s = 103s; SRI (no stop) = 011 = 3
	
	init_timer(3,0,0,3,0xFE502A); // 1.5Hz, TIMER3 -> lampeggia sui led il counter degli scartati
