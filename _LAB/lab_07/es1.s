...
Reset_Handler   PROC
				...
				LDR r1, =Best_times
				LDR r2, =Failed_runs
				MOV r9, r2				; r9 = indirizzo iniziale di r2
				MOV r3, #7				; contatore da decrementare
				MOV r6, #7				; contatore nested loop
				MOV r11, #0				; contatore di giorni >= 1300
				MOV r10, #0				; somma di failed_runs
				MOV r12, #1300
